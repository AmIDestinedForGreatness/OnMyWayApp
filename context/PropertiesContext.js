...
export const INITIAL_PROPERTIES = [
  ...
  },
  {
    ...
    bathrooms: 1,
    sqm: 50,
    address: 'Quezon City (tap to update)',
    description: 'Test listing for development. Edit the details in PropertiesContext.js — change latitude/longitude to move the pin anywhere on the map.',
    amenities: ['WiFi', 'Aircon', 'Kitchen', 'Parking'],
    maxGuests: 4,
    minNights: 1,
    seller: { name: 'Yujin', phone: '09171234567', member: 'Host since 2026', rating: 5.0, reviews: 0 },
